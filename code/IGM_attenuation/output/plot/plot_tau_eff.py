...
plot(tau_LAF_data[5][:,2],tau[5],'g--',linewidth=lw,label='$v_{out}=200km/s$')
plot(tau_LAF_data[6][:,2],tau[6],'g-.',linewidth=lw,label='$v_{out}=400km/s$')
plot(tau_LAF_data[7][:,2],tau[7],'g:',linewidth=lw,label='$v_{out}=600km/s$')
lg=plt.legend(loc='lower left')
lg.draw_frame(False)
