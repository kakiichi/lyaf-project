...
#set cbrange [-1:2]
set cbrange [-0.6:1.6]
set title "v_{out}=0km/s (fid.)" font "Times-Roman,15"
...
#set cbrange [-1:2]
set cbrange [-0.6:1.6]
set title "v_{out}=200km/s" font "Times-Roman,15"
splot 'RSD_06.out' u 3:4:(log10($5))
...
set cbrange [-0.6:1.6]
set title "v_{out}=400km/s" font "Times-Roman,15"
splot 'RSD_07.out' u 3:4:(log10($5))
...
set cbrange [-0.6:1.6]
set title "v_{out}=600km/s" font "Times-Roman,15"
splot 'RSD_08.out' u 3:4:(log10($5))
