...
#set cbrange [-1:2]
set cbrange [-0.6:1.6]
set title "{/Symbol s}_{12}=200km/s (fid.)" font "Times-Roman,15"
...
#set cbrange [-1:2]
set cbrange [-0.6:1.6]
set title "{/Symbol s}_{12}=180km/s" font "Times-Roman,15"
splot 'RSD_09.out' u 3:4:(log10($5))
...
set cbrange [-0.6:1.6]
set title "{/Symbol s}_{12}=220km/s" font "Times-Roman,15"
splot 'RSD_10.out' u 3:4:(log10($5))
